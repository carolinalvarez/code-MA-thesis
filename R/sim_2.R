...
writeLines(capture.output(time_measure_L),"C:/Users/Philipp/Desktop/code-MA-thesis copy/output/time_measure_m.txt")
...
write.csv(res, file = "C:/Users/Philipp/Desktop/code-MA-thesis copy/output/sim_m.csv", row.names = FALSE)
...
writeLines(capture.output(time_measure_L), "C:/Users/Philipp/Desktop/code-MA-thesis copy/output/time_measure_n.txt")
...
write.csv(res, file ="C:/Users/Philipp/Desktop/code-MA-thesis copy/output/sim_n.csv", row.names = FALSE)
