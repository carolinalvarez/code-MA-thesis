...
#' 
#' N: Integer, size of desired population
#' r: Imbalanced ratio, as the rate of class 0, P(Y=0|X=x)
#' distribution: Distribution of predictors. Options: Gaussian.
#' k : Length of predictor vector.
#' mean1 : mean of class 1 (minority class)
#' mean0: mean of class 0
#' sigma1: variance-covariance of predictors of class1
#' sigma0: variance-covariance of predictors of class0
#' 


dgp.imbalanced <- function(N = NULL
                           , r = NULL
                           , distribution = NULL
                           , k = NULL
                           , mean1 = NULL
...
get.true.intercept <- function(r=NULL, x0=NULL, betas=NULL){
...
cc_algorithm <- function(data=NULL, a=NULL){
...
cc_algorithm_Ns <- function(data=NULL, a=NULL){
  # Function that subsamples from an implicit population (not used for the thesis)
...
logit_predict <- function(data=NULL, names.use=NULL, betas=NULL){
  #' Prediction function
...
#'   NOTE 14.06: Funtion not used in the final analysis
#'   
#'   train_idx <- c()
#'   test_idx <- c()
#'   
...
a_bar <- function(a=NULL, r=NULL){
  a_bar <- a*(1-r) + (1-a) * r
  return(a_bar)
}

prop_Ps <-function(a=NULL, r=NULL){
  a1 <- a
  a0 <- 1-a
...
gdp.imbalanced.Ns <- function(a=NULL
                              , r=NULL
                              , distribution=NULL
                              , Ns_size=NULL
                              , k=NULL
...
# WCC subsampling as presented in Fithian and Hastie (2014) 

wcc_algorithm <- function(data=NULL, a=NULL){
...
wcc_algorithm_Ns <- function(data=NULL, a=NULL){
...
#   #NOTE 14.06: this function was not used, as Fithian and Hastie still use a data-dependet
#   #pilot
#   
...
lcc_algorithm_v2 <- function(data = NULL, a_wcc = NULL){
  ...
  k <- length(data) - 1 
  #here I do not split the data. I do a wcc pass on the whole data for the pilot, thus data dependent pilot
...
cc_algorithm_fixed <- function(data=NULL, r=NULL, a=NULL, ns_fixed=NULL){
...
wcc_algorithm_fixed <- function(data=NULL, r=NULL, a=NULL, ns_fixed=NULL){
...
lcc_algorithm_fixed <- function(data=NULL, r=NULL, a_wcc=NULL, ns_fixed=NULL){
...
average_subsample_size <- function(N=NULL
                                   , k=NULL
                                   , a=NULL
                                   , r=NULL
                                   , mean1=NULL
