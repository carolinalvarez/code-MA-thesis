...
# var_lcc
# 
# write.csv(res, file = "~/Documents/Master/thesis/02-Thesis/code/code-MA-thesis/output/sim_e3.csv", row.names = FALSE)
# 
# 
# # Simulation E_4
# 
...
# var_lcc
# 
# write.csv(res, file = "~/Documents/Master/thesis/02-Thesis/code/code-MA-thesis/output/sim_e4.csv", row.names = FALSE)
# 
# 
# 
